...
'Lots of Groups' => 'Trop de groupes',
'Allow to filter the group list (hide some groups) on users admin page.' => "Utiliser un filtre pour cacher certains groupes sur la page d'administration des utilisateurs.",
